  ...
  <div className={classes('privacy', {
    ...
    <section className="privacy__body">
      ...
      <div className="privacy__section">
        ...
        For a better experience while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to your name, date of birth, email address. The information that we collect will be used to contact or identify you.
      </div>
      <div className="privacy__section">
        <h2>Log Data</h2>
